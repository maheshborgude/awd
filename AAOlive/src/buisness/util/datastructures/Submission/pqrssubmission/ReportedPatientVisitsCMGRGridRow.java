 ...
 * Date 08/02/2016
 */
public class ReportedPatientVisitsCMGRGridRow implements Comparable<ReportedPatientVisitsCMGRGridRow> {
	 ...
	 * 
	 */
	ReportedPatientVisitsCMGRGridRow(String firstName, String lastName, String grnder, String dateOfBirth, String mrn, String medicare, String dateOfSurgery, String operativeEye)
	{
	...
	@Override
	public int compareTo(ReportedPatientVisitsCMGRGridRow target) {
