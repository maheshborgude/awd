...
/**
 * Verifies Patient DrillDown Sorting present on Dashboard > Practice > Select measure >> Provider Tab For Rolling<p>
...
public class PracticeProvidersPatientDrillDownSortR extends PatientDrillDownSort{
	/**
	 * Method to compare object of sorted data present on Patient DrillDown Sorting present on Dashboard > Practice > Select measure >> Provider Tab For Rolling<p>
	...
	public boolean verify(String elementmethod,String locator,String data1, String data2)
	{
		...
		String query = config.getQuery("PracticeProvidersPatientDrillDownSortR");
