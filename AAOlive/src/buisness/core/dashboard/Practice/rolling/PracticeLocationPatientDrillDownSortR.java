...
/**
 * Verifies Practice >Location Tab>> Patient DrillDown Sorting present on Dashboard > Practice > Select measure >> Location Tab For Rolling<p>
...
public class PracticeLocationPatientDrillDownSortR extends PatientDrillDownSort{
	/**
	...
	public boolean verify(String elementmethod,String locator,String data1, String data2)
	{
		...
		String query = config.getQuery("PracticeLocationPatientDrillDownSortR");
