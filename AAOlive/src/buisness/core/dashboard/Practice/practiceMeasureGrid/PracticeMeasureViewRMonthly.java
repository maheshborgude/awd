...
public class PracticeMeasureViewRMonthly extends DefaultMeasureGridComp{
	 ...
	 * Returns boolean true if grid from  UI and Database match data<p>
	 * Returns boolean false if grid from UI and Database do not match<p>
	 */

	public boolean verifyPMViewRMonthly(String locator,String elementmethod,String data,String data1)
	{
		...
		DefaultMeasureGrid uiGrid =getWebgrid(locator,elementmethod);
		if(uiGrid!=null ) 
		{
