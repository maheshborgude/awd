...
/**
 * Verifies Practice >Location Tab>> Patient DrillDown Sorting present on Dashboard > Practice > Select measure >> Location Tab For nonRolling<p>
...
public class PracticeLocationPatientDrillDownSortNR extends PatientDrillDownSort{
	/**
	 * Method to compare object of sorted data present on Practice >Location Tab>> Patient DrillDown Sorting present on Dashboard > Practice nonRollin <p>
	...
	public boolean verify(String elementmethod,String locator,String data1, String data2)
	{
		...
		String query = config.getQuery("PracticeLocationPatientDrillDownSortNR");
