...
/**Verifies Practice Location Measure Computation Summary View present on Practice >> Select Measure >> Location Tab >> Select Loacation  For NonRolling<p>
...
public class PracticeLocationMeasureComputationSummaryViewNR extends MeasureComputationSummaryView{
	...
	public boolean verify(String locator,String elementmethod,String data)
	{
		...
		String query = config.getQuery("PracticeLocationMeasureComputationSummaryViewNR");
