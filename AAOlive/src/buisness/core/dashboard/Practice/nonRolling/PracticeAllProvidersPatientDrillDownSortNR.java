...
/**
 * Verifies validate Sort of Patient Drill Down present on Dashboard >> Practice >> All tab - Providers For nonRolling
...
public class PracticeAllProvidersPatientDrillDownSortNR extends PatientDrillDownSort{
	/**
	 * Method to compare object of sorted data present on Patient Drill Down present on Dashboard >> Practice >> All tab - Providers For nonRolling
	...
	public boolean verify(String elementmethod,String locator,String data1, String data2)
	{
		...
		String query = config.getQuery("PracticeAllProvidersPatientDrillDownSortNR");
