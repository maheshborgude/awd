...
/**Verifies Favorites Measure View present on Dashboard > Practice For NOnRolling<p>
...
public class PracticeFavoritesMeasureViewNR extends MeasureView{
	
	/**
	 *This method is used to compare UI Grid data  with Database grid data For NonRolling and Favorites Measure<p>
	...
	public boolean verify(String locator,String elementmethod,String data)
	{
		...
		String query = config.getQuery("PracticeFavoritesMeasureViewNR");
		...
		MeasureGrid databaseGrid =getDatabaseGrid(query);
		MeasureGrid webGrid =getWebGrid(locator,elementmethod);
		if(webGrid!=null )
		{
