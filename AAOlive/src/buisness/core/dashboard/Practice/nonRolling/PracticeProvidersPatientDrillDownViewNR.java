...
/**
 * Verifies Patient DrillDown view present on Dashboard > Practice > Select measure >> Provider Tab For nonRolling<p>
 ...
 */
public class PracticeProvidersPatientDrillDownViewNR extends PatientDrillDownView{
	/**
	 * verify Patient DrillDown view present on Dashboard > Practice > Select measure >> Provider Tab For nonRolling<p>
	...
	public boolean verify(String locator,String elementmethod,String data)
	{
		...
		String query = config.getQuery("PracticeProvidersPatientDrillDownViewNR");
