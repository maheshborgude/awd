...
/**
 * Verifies Patient DrillDown Pagination present on Dashboard > Practice > Select measure >> Provider Tab For nonRolling<p>
...
public class PracticeProvidersPatientDrillDownPaginationNR extends PatientDrillDownPagination {

    /**
     * Method to compare object Patient DrillDown Pagination present on Dashboard > Practice > Select measure >> Provider Tab For nonRolling<p>
    ...
    public boolean verify(String elementmethod, String locator, String data) {
        ...
        String query = config.getQuery("PracticeProvidersPatientDrillDownPaginationNR");
