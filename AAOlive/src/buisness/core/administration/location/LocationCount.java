...
public class LocationCount extends Location {
	...
	public String getdbcount()
	{
		...
		String query = config.getQuery("Locationgridcount");
		...
		try {
			...
			{
				Setup.log.trace("No Provider Record found in the Database.");
			}
		...
		{
			Setup.log.error("Query syntax incorrect.");
		}
		Setup.testcase.fail();
		return "0";
	}
	 ...
	 */
	public boolean CompareDBAndUI(String locator)  
	{
//		String dbCount;
//		String uiCount;
//		
