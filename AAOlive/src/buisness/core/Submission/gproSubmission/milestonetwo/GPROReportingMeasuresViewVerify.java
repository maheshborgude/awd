...
/**Verifies GPRO Reporting Measures Grid(GPROSubmission)<p>
 * @author Sachin.Gawade<p>
 * Created Date: 29 Feb 2016
 * 
 */

public class GPROReportingMeasuresViewVerify extends ReportingMeasuresView{
	...
	{
		ReportingMeasureGrid dbGrid =getDatabaseGrid("GroupPracticeMeasure");
