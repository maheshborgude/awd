...
/**
 * This class used to get PQRS Submission >> Submission 2015 >> Report PQRS Measures Milestone >>Reported Patient Visits Tab
 ...
 * Date : 28/1/2015
 */
public class ReportedPatientVisitsCMGRSort extends ReportedPatientVisitsCMGR {
	
	public ReportedPatientVisitsCMGRGrid getDbGrid() {
		ConfigurationManager config = new ConfigurationManager();
		String query = config.getQuery("ReportedPatientVisitsCMGRSort");	
		String replacekey="";
