...
/**
 * Verifies Practice >AllProviders Tab>> Patient DrillDown pagination present on Dashboard > Practice > Select measure >> All Tab For nonRolling<p>
...
public class PracticeAllProvidersPatientDrillDownPaginationNR extends PatientDrillDownPagination {

    /**
     * Method to Practice >AllProviders Tab>> Patient DrillDown pagination present on Dashboard > Practice > Select measure >> All Tab For nonRolling<p>
    ...
    public boolean verify(String elementmethod, String locator, String data) {
        ...
        String query = config.getQuery("PracticeAllProvidersPatientDrillDownPaginationNR");
