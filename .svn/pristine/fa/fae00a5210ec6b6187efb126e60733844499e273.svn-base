package testcases.mips;
	...
	public class TC_MipsProviderlist extends Setup {ConfigurationManager rd=new ConfigurationManager();
	...
	public void testBlankPassword(Hashtable <String,String> data) throws IOException, InvalidFormatException
	{
		...
		exe.testexecute(Filelocation,"TC_MipsProviderlist",data);
	...
	{
	    String Filelocation=System.getProperty("user.dir")+rd.read_Configfile("MipsProviderexcell");
	    Object[][] object=ex.getDataingrid(Filelocation,"TC_MipsProviderlistData");
	    return object;    
	}
	}
