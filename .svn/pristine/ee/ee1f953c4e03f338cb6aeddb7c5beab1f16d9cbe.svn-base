...
/**
 * Verifies Patient DrillDown view present on Dashboard > Practice > Select measure >> Provider Tab For Rolling<p>
 ...
 */
public class PracticeProvidersPatientDrillDownViewR extends PatientDrillDownView{
	
	/**
	 * verify Patient DrillDown view present on Dashboard > Practice > Select measure >> Provider Tab For Rolling<p>
	...
	public boolean verify(String locator,String elementmethod,String data)
	{
		...
		String query = config.getQuery("PracticeProvidersPatientDrillDownViewR");
