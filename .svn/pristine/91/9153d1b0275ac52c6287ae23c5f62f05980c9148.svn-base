...
/**
 * Verifies Practice >Location Tab>> Patient DrillDown Count present on Dashboard > Practice > Select measure >> Location Tab For Rolling<p>
 ...
 * 
 */
public class PracticeLocationPatientDrillDownCountR extends ProviderPatientDrillDownCount{

	/**
	 * Method to compare object of sorted data present on Practice >Location Tab>> Patient DrillDown Sorting present on Dashboard > Practice Rolling <p>
	...
	public boolean verify(String elementmethod,String locator,String data)  
	{
		...
		String query = config.getQuery("PracticeLocationPatientDrillDownCountR");
