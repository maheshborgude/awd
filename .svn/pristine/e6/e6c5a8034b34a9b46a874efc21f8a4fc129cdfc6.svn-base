...
/**
 * Verifies Count of AllProviders present on Dashboard > Practice >> Select Measure >> All Tab For NOnRolling<p>
 ...
 * 
 */
public class PracticeAllProvidersPopUpCountNR extends ProviderLocationCount {

	/**
	 * Compares Count of AllProviders present on Dashboard > Practice >> Select Measure >> All Tab For NOnRolling<p>
	 ...
	 */
	public boolean verifyPracticeAllProvidersPopUpCountNR(String elementmethod,String locator,String data, String data1)  
	{
		String databaseCount;
		String webCount;
		ConfigurationManager config=new ConfigurationManager();
		String query = config.getQuery("PracticeAllProvidersPopUpCountNR");
