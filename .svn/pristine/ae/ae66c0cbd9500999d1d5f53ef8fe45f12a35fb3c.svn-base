...
public class ConfigurationManager {
	   ...
	   public String read_ObjectRepositoryfile(String scriptname) 
	   {
		   ...
		   {
			   Properties or_prop=new Properties();
			   FileInputStream or_file=new FileInputStream(System.getProperty("user.dir")+"\\Configurations\\Object Repository\\ObjectRepository.properties");
			   or_prop.load(or_file);
			   property=or_prop.getProperty(scriptname);
		   } catch (FileNotFoundException e) 
		   {
	   ...
	   public String getQuery(String scriptname) 
	   {
		   ...
		   try 
		   {
			   ...
			   or_file = new FileInputStream(System.getProperty("user.dir")+"\\Configurations\\Queries\\NewQueries.properties");
			   or_prop.load(or_file);
			   property=or_prop.getProperty(scriptname);
		   } catch (FileNotFoundException e) 
		   {
