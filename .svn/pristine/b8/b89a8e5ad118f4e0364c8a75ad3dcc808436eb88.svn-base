...
/**
 * Verifies validate Sort of Patient Drill Down present on Dashboard >> Practice >> All tab - Providers For Rolling
...
public class PracticeAllProvidersPatientDrillDownSortR extends PatientDrillDownSort{
	/**
	 * Method to compare object of sorted data present on Patient Drill Down present on Dashboard >> Practice >> All tab - Providers For Rolling
	...
	public boolean verify(String elementmethod,String locator,String data1, String data2)
	{
		...
		String query = config.getQuery("PracticeAllProvidersPatientDrillDownSortR");
