...
/**
 * Verifies Practice Location Measure Computation Summary View present on Loaction >> Measure
 *      Select Measure For Rolling<p>
...
public class LocationMeasureMeasureComputationSummaryViewR extends MeasureComputationSummaryView{
	...
	public boolean verify(String locator,String elementmethod,String data)
	{
		...
		String query = config.getQuery("LocationMeasureMeasureComputationSummaryViewR");
