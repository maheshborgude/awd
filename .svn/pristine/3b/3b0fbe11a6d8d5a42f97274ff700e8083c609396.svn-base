...
/**
 * This test case validate Sorting of Tax Identification Number present on PQRS Submission >> Submission 2015 
 ...
 * Date 20-1-2016
 */
public class TC_TaxIdentificationNumberSort extends Setup{
	
	ConfigurationManager rd=new ConfigurationManager();
	TestExecutor exe = new TestExecutor();
    ExcelReader ex = new ExcelReader();	
	@Test(dataProvider="TaxIdentificationNumberSort")
	public void TC_AllMeasures(Hashtable <String,String> data) throws IOException, InvalidFormatException
	{
		...
		exe.testexecute(Filelocation,"TC_TaxIdentificationNumberSort",data);
		log.info("\nTC To validate Data of practice present onTax Identification Number tab under Manage provider Profile milestone Ends");
		Setup.testcase.assertAll();
	}
	@DataProvider(name="TaxIdentificationNumberSort")
    public Object[][] getDataFromDataprovider12() throws IOException, InvalidFormatException
	{
        String Filelocation=System.getProperty("user.dir")+rd.read_Configfile("PQRSSubmission_Submission");
        Object[][] object=ex.getDataingrid(Filelocation,"TC_TaxIdentificationNumberSort_Data");
