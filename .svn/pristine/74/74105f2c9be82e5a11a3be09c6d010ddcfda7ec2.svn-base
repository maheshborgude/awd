...
/**Verifies Pagination of Pqrs Advanced Status IMR Pagination Grid(PQRSubmission) present on Report PQRS Measures<p>
 ...
 * 
 */
public class PqrsAdvancedStatusIMRPagination extends AdvancedStatus{
	/**
	 * Passes querylocator
	...
	public boolean verify(String elementmethod,String locater)
	{
		...
		String query = config.getQuery("PqrsAdvancedStatusIMRPagination"); 
