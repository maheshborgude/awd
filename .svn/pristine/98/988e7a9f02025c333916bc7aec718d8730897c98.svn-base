...
public class PracticeAllProvidersMeasureComputationSummaryViewR extends MeasureComputationSummaryView{
	...
	public boolean verify(String locator,String elementmethod,String data)
	{
		...
		String query = config.getQuery("PracticeAllProvidersMeasureComputationSummaryViewR");
