...
public class TC_VerifyMeasureCount extends Setup  {

		ConfigurationManager rd=new ConfigurationManager();
		TestExecutor exe=new TestExecutor();
	    ExcelReader ex= new ExcelReader();
	
	    @Test(dataProvider="TC_VerifyMeasureCount")
		public void testBlankPassword(Hashtable <String,String> data) throws IOException, InvalidFormatException
		{
	    	...
	    	System.out.println("\nTest Case: VerifyMeasureCount starts");
	    	Setup.log.info("\nCheckScore test case starts");
	    	exe.testexecute(Filelocation,"TC_VerifyMeasureCount",data);
	    	System.out.println("Test Case: VerifyMeasureCount end");
	    	Setup.log.info("\nVerifyMeasureCount test case ends");
	    	Setup.testcase.assertAll();
		}

		@DataProvider(name="TC_VerifyMeasureCount")
	    public Object[][] getDataFromDataproviderPassword() throws IOException, InvalidFormatException
		{
	        String Filelocation=System.getProperty("user.dir")+rd.read_Configfile("dashboard_practice_excel");
	        Object[][] object=ex.getDataingrid(Filelocation,"TC_VerifyMeasureCount_Data");
	        return object;    
	    }
}
