package testcases.dashboard.provider.rolling;
	...
	public class TC_ProviderBubbleCountR extends Setup {
		...
		@Test(dataProvider="ProviderBubbleCountR")
		public void TC_AllMeasures(Hashtable <String,String> data) throws IOException, InvalidFormatException
		{
			...
			exe.testexecute(Filelocation,"PBubbleCountR",data);
			log.info("\nTC To validate bubble count for Location on dashboard non rolling Ends");
			Setup.testcase.assertAll();
		}
		@DataProvider(name="ProviderBubbleCountR")
	    public Object[][] dataProvider() throws IOException, InvalidFormatException
		{
	        String Filelocation=System.getProperty("user.dir")+rd.read_Configfile("DashboardProvider");
	        Object[][] object=ex.getDataingrid(Filelocation,"PBubbleCountR_Data");
