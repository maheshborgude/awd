...
/**
 * Verifies Practice >Location Tab>> Patient DrillDown view present on Dashboard > Practice > Select measure >> Location Tab For nonRolling<p>
 ...
 */
public class PracticeLocationPatientDrillDownViewNR extends PatientDrillDownView{
	...
	public boolean verify(String locator,String elementmethod,String data)
	{
		...
		String query = config.getQuery("PracticeLocationPatientDrillDownViewNR");
