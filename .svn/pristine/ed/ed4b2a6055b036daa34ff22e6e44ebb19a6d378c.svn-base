...
public class TC_PracticeProvidersPatientDrillDownCountR extends Setup{
	...
	@Test(dataProvider="PracticeProvidersPatientDrillDownCount")
	public void TC_PPPatientDrillDown(Hashtable <String,String> data) throws IOException, InvalidFormatException
	{
		...
		exe.testexecute(Filelocation,"TC_PProvidersPDDCount",data);
		log.info("\nTC To validate count of Patient Drill Down present on Providers tab for Rolling Ends");
		Setup.testcase.assertAll();
	}
	@DataProvider(name="PracticeProvidersPatientDrillDownCount")
    public Object[][] dataProvider() throws IOException, InvalidFormatException
	{
        String Filelocation=System.getProperty("user.dir")+rd.read_Configfile("Practice_Provider");
        Object[][] object=ex.getDataingrid(Filelocation,"TC_PProvidersPDDCount_Data");
