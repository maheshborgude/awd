 ...
 * For selected provider user in the database<p>
 * @author rakesh.kulkarni
 * Date : 28/1/2015
 */
public class TaxIdentificationNumberSort extends TaxIdentificationNumber	 {
	/**
	 * Default constructor for object creation   
	 */
	public TaxIdentificationNumberSort(){
	}	
	public TaxIdentificationNumberGrid getDbGrid() {
		ConfigurationManager config = new ConfigurationManager();
		String query = config.getQuery("TaxIdentificationNumberSort");	
