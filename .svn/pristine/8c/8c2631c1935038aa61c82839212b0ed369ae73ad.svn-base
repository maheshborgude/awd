...
/**Verifies Practice AllProviders View of All Providers on Dashboard > Practice >> Select Measure on All tab For NOnRolling<p>
 ...
 * 
 */
public class PracticeAllProvidersPopUpViewNR extends PracticeLocationPopUp {
...
/*		query=query.replace( "@provideruid",getSelectedProvierUID());
	...
	public boolean verifyPracticeAllProvidersPopUpViewNR(String elementmethod,String locator ,String data,String data1)
	{
		ConfigurationManager config=new ConfigurationManager();
		String query = config.getQuery("PracticeAllProvidersPopUpViewNR");
