...
/**
 * This test case validate View of Measure present on Dashboard >> Location For Rolling
 ...
 * Date 30/03/2016
 */
public class TC_LocationMeasureViewR extends Setup{
	
	ConfigurationManager rd=new ConfigurationManager();
	TestExecutor exe = new TestExecutor();
    ExcelReader ex = new ExcelReader();	
	@Test(dataProvider="LocationMeasureViewR")
	public void TC_AllMeasures(Hashtable <String,String> data) throws IOException, InvalidFormatException
	{
		...
		exe.testexecute(Filelocation,"TC_LMeasureViewR",data);
		log.info("\nTC To validate View of Measure present on Dashboard >> Location for Rolling Ends");
		Setup.testcase.assertAll();
	}
	@DataProvider(name="LocationMeasureViewR")
    public Object[][] dataProvider() throws IOException, InvalidFormatException
	{
        String Filelocation=System.getProperty("user.dir")+rd.read_Configfile("Dashboard_Location");
        Object[][] object=ex.getDataingrid(Filelocation,"TC_LMeasureViewR_Data");
