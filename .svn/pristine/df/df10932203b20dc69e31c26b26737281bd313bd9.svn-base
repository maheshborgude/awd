...
/**Verifies Practice Provider Measure Computation Summary View present on Practice >> Select Measure >> Provider Tab >> Select Provider For Rolling<p>
...
public class PracticeProviderMeasureComputationSummaryViewR extends MeasureComputationSummaryView{

	/**
	 *This method is used to compare UI Grid data Practice Location Measure Computation Summary View present on Practice
	 *        Provider Measure Computation Summary View present on Practice >> Select Measure >> Provider Tab >> Select Provider For Rolling<p>
	...
	public boolean verify(String locator,String elementmethod,String data)
	{
		...
		String query = config.getQuery("PracticeProviderMeasureComputationSummaryViewR");
