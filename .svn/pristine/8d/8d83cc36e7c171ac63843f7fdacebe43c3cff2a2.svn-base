...
/**
 * Verifies Submission Details view present on Dashboard > Practice For NOnRolling<p>
 ...
 * Date : 16/03/2016
 */
public class SubmissionDetailsViewNR extends SubmissionDetails {
	/**
	 * Default constructor for object creation
	 */
	public SubmissionDetailsViewNR(){
	}	
	public SubmissionDetailsGrid getDbGrid() {
		ConfigurationManager config = new ConfigurationManager();
		String query = config.getQuery("SubmissionDetailsViewNR");
		return super.getDatabaseGrid(query);
	}
	/**
	 * Passes locator : To Find the element
	 * Passes Parameters elementmethod and locator to verify() Submission Details view present on Dashboard > Practice For NOnRolling
