...
/**
 * Verifies Practice >Location Tab>> Patient DrillDown view present on Dashboard > Practice > Select measure >> Location Tab For Rolling<p>
 ...
 */
public class PracticeLocationPatientDrillDownViewR extends PatientDrillDownView{
	...
	public boolean verify(String locator,String elementmethod,String data)
	{
		...
		String query = config.getQuery("PracticeLocationPatientDrillDownViewR");
