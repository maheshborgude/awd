...
/**
/**
 * This test case validate Reported Patient Visits For Qualified Clinical Data Registry Reporting Pagination present on PQRS Submission >> Submission 2015 
 *      >> Report PQRS Measures Milestone >>Reported Patient Visits QCDRR >> Pagination
 ...
 * Date : 03/02/2015
 */
public class ReportedPatientVisitsQCDRRPagination extends ReportedPatientVisitsQCDRR {
	/**
	 * Default constructor for object creation   
	 */
	public ReportedPatientVisitsQCDRRPagination(){
	}	

	/**	
	 * This method verify pagination of QCDR Advanced Status and click  on First last forward backward 
	...
	public boolean verify(String elementmethod,String locater)
	{
		...
		String query = config.getQuery("ReportedPatientVisitsQCDRRPagination");
