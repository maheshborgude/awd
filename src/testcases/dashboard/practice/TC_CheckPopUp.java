...
public class TC_CheckPopUp extends Setup  {
		...
		public void testBlankPassword(Hashtable <String,String> data) throws IOException, InvalidFormatException
		{
	    	...
	    	System.out.println("\nTest Case: TC_CheckPopWindow starts");
	    	Setup.log.info("\nTC_CheckPopWindow test case starts");
	    	exe.testexecute(Filelocation,"TC_CheckPopWindow",data);
	    	System.out.println("Test Case: TC_CheckPopWindow end");
	    	Setup.log.info("\nTC_CheckPopWindow test case ends");
		...
		{
	        String Filelocation=System.getProperty("user.dir")+rd.read_Configfile("dashboard_practice_excel");
	        Object[][] object=ex.getDataingrid(Filelocation,"TC_CheckPopWindow_Data");
	        return object;    
	    }
}
