 ...
 *          on Dashboard >> Practice >> All tab For Rolling
 ...
 * Date 28/03/2016
 */
public class TC_PracticeAllPerformanceTrendViewR extends Setup  {
		...
		public void startTestCase(Hashtable <String,String> data) throws IOException, InvalidFormatException
		{
	    	...
	    	Setup.log.info("TC_PracticeAllPerformanceTrendViewR test case starts");
	    	exe.testexecute(Filelocation,"TC_PAllPerTrendViewR",data);
	    	Setup.log.info("TC_PracticeAllPerformanceTrendViewR case ends");
		...
		{
	        String Filelocation=System.getProperty("user.dir")+rd.read_Configfile("dashboard_practice");
	        Object[][] object=ex.getDataingrid(Filelocation,"TC_PAllPerTrendViewR_Data");
	        return object;    
	    }
}
