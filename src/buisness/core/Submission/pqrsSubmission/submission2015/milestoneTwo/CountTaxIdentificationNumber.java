...
/**
 * This class is used to validate the count Tax Identification Number
 ...
 * Date 29-02-2016
 */
public class CountTaxIdentificationNumber extends DashboardUI{
 ...
 */
	public int getDatabaseCount()
	{
		...
		String query = cofig.getQuery("CountTaxIdentificationNumber");	
		ResultSet resultSet =null; //Set to null initially  
		int dbresult = 0;
		try {
