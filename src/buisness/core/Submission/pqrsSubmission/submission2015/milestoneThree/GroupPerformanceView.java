...
/**Verifies Group Performance Grid (PQRSubmission) present on Report PQRS Measures<p>
 ...
 * 
 */
public class GroupPerformanceView extends GroupPerformance{
	/**
	 * Passes querylocator
	...
	public boolean verify(String elementmethod,String locator)
	{
		...
		GroupPerformanceGrid  dbGrid =getDatabaseGrid("GroupPerformanceViewNew");
