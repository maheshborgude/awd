...
/**
 * This class is used to validate the count of Qualified Clinical Data Registry Reporting
 * present on to the Report PQRS Measures milestone 
 ...
 * Date 02/03/2016
 */
public class ReportedPatientVisitsIMRCount extends DashboardUI{
 ...
 */
	public int getDatabaseCount()
	{
		...
		String query = cofig.getQuery("ReportedPatientVisitsIMRCount");	
