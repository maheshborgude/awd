...
/**Verifies Sorting of Pqrs Advanced Status CMGR Sort Grid(PQRSubmission) Present on Report PQRS Measures milestone<p>
 * Extends PqrsAdvancedStatusViewSort<p>
 * This class pass Query Keyword to Extended PqrsAdvancedStatusViewSort class
 * This class pass the keywords present in Queries.properties
 * @author Rakesh.kulkarni<p>
 * Created Date: 03/03/2016
 * 
 */
public class PqrsAdvancedStatusCMGRSort extends AdvancedStatusSort{
	/**
	 * Passes querylocator
	...
	public boolean verify(String elementmethod,String locator,String data)
	{
		...
		AdvancedStatusGrid  dbGrid =getDatabaseGrid("PqrsAdvancedStatusCMGRSort","asc");
