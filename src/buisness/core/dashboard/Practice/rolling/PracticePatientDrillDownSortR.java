...
public class PracticePatientDrillDownSortR extends PatientDrillDownSort{
	/**
	 * Method to compare object of sorted present on Dashboard > Practice > Measure computation summary For Rolling <p>
	...
	public boolean verify(String elementmethod,String locator,String data1, String data2)
	{
		...
		String query = config.getQuery("PracticePatientDrillDownSortR");
