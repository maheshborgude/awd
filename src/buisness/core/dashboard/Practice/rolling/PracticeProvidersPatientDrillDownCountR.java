...
/**
 * Verifies Practice >Provider Tab>> Patient DrillDown Count present on Dashboard > Practice > Select measure >> Provider Tab For Rolling<p>
 ...
 * 
 */
public class PracticeProvidersPatientDrillDownCountR extends ProviderPatientDrillDownCount{
	...
	public boolean verify(String elementmethod,String locator,String data)  
	{
		...
		String query = config.getQuery("PracticeProvidersPatientDrillDownCountR");
