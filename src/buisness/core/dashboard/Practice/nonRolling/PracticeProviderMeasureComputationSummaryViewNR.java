...
/**Verifies Practice Provider Measure Computation Summary View present on Practice >> Select Measure >> Provider Tab >> Select Provider For NonRolling<p>
...
public class PracticeProviderMeasureComputationSummaryViewNR extends MeasureComputationSummaryView{
	
	/**
	 *This method is used to compare UI Grid data Practice Location Measure Computation Summary View present on Practice
	 *        Provider Measure Computation Summary View present on Practice >> Select Measure >> Provider Tab >> Select Provider For NonRolling<p>
	...
	public boolean verify(String locator,String elementmethod,String data)
	{
		...
		String query = config.getQuery("PracticeProviderMeasureComputationSummaryViewNR");
