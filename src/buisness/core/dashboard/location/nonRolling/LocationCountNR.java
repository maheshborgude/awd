 ...
 *
 */
public class LocationCountNR extends ProviderLocationCount {
	 ...
	 */
	public boolean verifyLocationCountNR(String elementmethod,String locator,String data, String data1)
	{
		String databaseCount;
		String webCount;
		ConfigurationManager config=new ConfigurationManager();
		String query = config.getQuery("LocationCountNR");
