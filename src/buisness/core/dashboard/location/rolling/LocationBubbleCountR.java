 ...
 *
 */
public class LocationBubbleCountR extends ProviderLocationCount {
	 ...
	 */
	public boolean verifyLocationBubbleCountR(String elementmethod,String locator,String data,String data1)
	{
		String databaseCount;
		String webCount;
		ConfigurationManager config=new ConfigurationManager();
		String query = config.getQuery("LocationBubbleCountR");
