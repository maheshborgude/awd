 ...
 * Date 20-1-2016	
 */
public class UserGroupSort extends UserGroup {
    	 ...
    	 */
		public GroupManagementGrid getDatabaseGrid() {
			ConfigurationManager config = new ConfigurationManager();
			 query= config.getQuery("ValidateGroupSortingThroughExternallID");	
	...
	{
		GroupManagementGrid  dbGrid =getDatabaseGrid();
