...
import buisness.util.datastructures.mipsutil.MipscliniciangridRow;
 ...
 * Date 13/1/2015
 */
public class Mipsprovidergridrow implements Comparable<Mipsprovidergridrow> {
	 ...
	 * @param Inactive
	 */
	Mipsprovidergridrow(String PROVIDERNAME, String MIPSELIGIBILITY, String NPI, String TIN,String QUALITY,String ACI,String IA,String MIPSFINALSCORE,String SUBMISSIONSTATUS)
	{
	...
	@Override
public int compareTo(Mipsprovidergridrow exactmatch) {
		System.out.println("This method of Util grid row gets invoked.");
		System.out.println(this.PROVIDERNAME);
		System.out.println(exactmatch.PROVIDERNAME);
